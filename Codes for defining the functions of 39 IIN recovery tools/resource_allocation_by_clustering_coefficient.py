...
def resource_allocation_by_clustering_coefficient(global_json_path):
    ...
    output_json_path = '、resource_allocation_by_clustering_coefficient.json'
    with open(output_json_path, 'w') as f:
        json.dump(recovery_data, f, indent=4)

    global_data["resource_allocation_by_clustering_coefficient"] = output_json_path
