...
def network_assessment_of_betweenness_centrality(global_json_path):
    """
    Determine recovery order based on betweenness centrality and evaluate using population data.

    :param global_json_path: Path to the global data JSON file
    :param failure_file_path: Path to the failure data JSON file
    ...
    # Filter the betweenness centrality for only the failed nodes
    failed_nodes_betweenness = {node: betweenness_centrality[node] for node in failed_nodes if
                                node in betweenness_centrality}

    # Sort failed nodes by Betweenness Centrality (highest first)
    sorted_failed_nodes_by_betweenness = sorted(failed_nodes_betweenness, key=failed_nodes_betweenness.get,
                                                reverse=True)
    recovery_order = sorted_failed_nodes_by_betweenness  # Recovery order based solely on betweenness centrality
    ...
    result = {
        'recovery_order': recovery_order,  # Recovery order based on betweenness centrality
    ...
    output_json_path = 'network_assessment_of_betweenness_centrality.json'
    ...
    file_paths['network_assessment_of_betweenness_centrality'] = output_json_path
