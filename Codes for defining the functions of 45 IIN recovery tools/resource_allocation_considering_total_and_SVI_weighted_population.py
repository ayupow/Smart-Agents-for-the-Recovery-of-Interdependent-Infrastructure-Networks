...
def resource_allocation_considering_total_and_SVI_weighted_population(global_json_path):
    ...
    output_json_path = 'resource_allocation_considering_total_and_SVI_weighted_population.json'
    with open(output_json_path, 'w') as f:
        json.dump(daily_recovery_order, f, indent=4)

    global_data["resource_allocation_considering_total_and_SVI_weighted_population"] = output_json_path
...
print(resource_allocation_considering_total_and_SVI_weighted_population(global_json_path))
